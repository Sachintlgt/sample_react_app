...
export const NewLogin = props => {
    ...
    const [state, setState] = useState({
        email: "", password: "", emailCls: '', emailErr: '', passwordCls: "", passwordErr: "",countryErr: "", countryCls: "",
    ...
    useEffect(() => {
        if (prevLoginData && prevLoginData.loginData !== loginData) {
            if (loginData && _.has(loginData, 'data') && loginData.success === true) {
                ...
                let userSocialData = {
                    google: loginData.social_login && _.has(loginData.social_login, 'google') && Object.keys(loginData.social_login.google).length > 0 ? {...loginData.social_login.google, access_token: loginData.social_login.google.auth_token} : {}
                }
                if(getUserData && getUserData.planData){
                    userData.planData = getUserData.planData
                }
                User.setSocialUserDetails(userSocialData);
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        <form>
                                            ...
                                            <p className=" text-center">Don’t have a MyBizzHive account? <Link to={REGISTER}>FREE Sign Up</Link></p>
                                        </form>
