import {
  ...
  SUCCESS_COUNTRY_LIST, ERROR_COUNTRY_LIST,
...
export const authReducer = (state = DEFAULT_STATE, action = {
  ...
  switch (action.type) {
    ...
    case SUCCESS_COUNTRY_LIST:
        const countryListData = action.data;
        return { ...state,  countryListData }
    case ERROR_COUNTRY_LIST:
        const errorCountryListData = action.data;
        return { ...state,  countryListData:errorCountryListData }  
    default:
    return state;
  }
};